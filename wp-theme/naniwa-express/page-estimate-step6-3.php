...
<div class="page-body">
  <div class="inner">
    ...
    <form class="form-card" action="<?php echo esc_url( home_url( '/estimate-step7/' ) ); ?>" method="post" novalidate>
...
?>
      ...
      <button class="btn btn-back" type="submit" formaction="<?php echo esc_url( home_url( '/estimate-step6-2/' ) ); ?>" formnovalidate>←　戻る</button>
