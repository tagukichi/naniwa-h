<?php
/**
 * 固定ページ：STEP6 荷物情報について（スラッグ: estimate-items）
 *
...
?>
        <div class="form-row" style="grid-template-columns:1fr;">
          ...
          <div class="item-grid">
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/tv-50down.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">液晶テレビ：50インチ未満</span>
              <span class="counter">
                <button type="button" data-step="down" aria-label="液晶テレビ：50インチ未満を減らす">−</button>
                <input type="number" name="item[液晶テレビ：50インチ未満]" value="<?php echo esc_attr( naniwa_estimate_item( '液晶テレビ：50インチ未満' ) ); ?>" min="0" aria-label="液晶テレビ：50インチ未満の個数">
                <button type="button" data-step="up" aria-label="液晶テレビ：50インチ未満を増やす">＋</button>
              </span>
            </div>
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/tv-50up.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">液晶テレビ：50インチ以上</span>
              <span class="counter">
                <button type="button" data-step="down" aria-label="液晶テレビ：50インチ以上を減らす">−</button>
                <input type="number" name="item[液晶テレビ：50インチ以上]" value="<?php echo esc_attr( naniwa_estimate_item( '液晶テレビ：50インチ以上' ) ); ?>" min="0" aria-label="液晶テレビ：50インチ以上の個数">
                <button type="button" data-step="up" aria-label="液晶テレビ：50インチ以上を増やす">＋</button>
              </span>
            </div>
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/eltv-50down.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">有機ELテレビ：50インチ未満</span>
              <span class="counter">
                <button type="button" data-step="down" aria-label="有機ELテレビ：50インチ未満を減らす">−</button>
                <input type="number" name="item[有機ELテレビ：50インチ未満]" value="<?php echo esc_attr( naniwa_estimate_item( '有機ELテレビ：50インチ未満' ) ); ?>" min="0" aria-label="有機ELテレビ：50インチ未満の個数">
                <button type="button" data-step="up" aria-label="有機ELテレビ：50インチ未満を増やす">＋</button>
              </span>
            </div>
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/eltv-50up.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">有機ELテレビ：50インチ以上</span>
              <span class="counter">
                <button type="button" data-step="down" aria-label="有機ELテレビ：50インチ以上を減らす">−</button>
                <input type="number" name="item[有機ELテレビ：50インチ以上]" value="<?php echo esc_attr( naniwa_estimate_item( '有機ELテレビ：50インチ以上' ) ); ?>" min="0" aria-label="有機ELテレビ：50インチ以上の個数">
                <button type="button" data-step="up" aria-label="有機ELテレビ：50インチ以上を増やす">＋</button>
              </span>
            </div>
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/desktop-pc.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">デスクトップパソコン</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/notebook-pc.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ノートパソコン</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/game.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ゲーム機</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/stereo.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">オーディオ機器</span>
              <span class="counter">
        ...
        <div class="form-row" style="grid-template-columns:1fr;">
          ...
          <div class="item-grid">
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/washing-machine.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">縦型洗濯機</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/d-washing-machine.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ドラム式洗濯機</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/fridge-4door.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">冷蔵庫：4ドア以上</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/fridge-3door.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">冷蔵庫：3ドア</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/fridge-2door.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">冷蔵庫：2ドア</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/aircon.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">エアコン</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/toaster-oven.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">オーブントースター</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/microwave.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">電子レンジ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/gas-stove.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ガスコンロ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/electric-fan.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">扇風機</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/fan-heater.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ストーブ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/lighting.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">照明器具</span>
              <span class="counter">
        ...
        <div class="form-row" style="grid-template-columns:1fr;">
          ...
          <div class="item-grid">
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/wardrobe.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">洋ダンス（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/wardrobe-s.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">洋ダンス（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/wardrobe-w.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">和ダンス（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/wardrobe-m.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">和ダンス（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/seiri-1.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">整理ダンス（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/seiri-2.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">整理ダンス（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/bookshelf-1.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">本棚（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/bookshelf-2.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">本棚（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/cupboard-1.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">食器棚（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/cupboard-2.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">食器棚（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/costume-case.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">衣装ケース</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/color.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">カラーボックス</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/shoe-rack.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">下駄箱</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/sideboard.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">壁面収納</span>
              <span class="counter">
        ...
        <div class="form-row" style="grid-template-columns:1fr;">
          ...
          <div class="item-grid">
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/tvboard-l.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">テレビ台（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/tvboard-m.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">テレビ台（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/diningtable4.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">食卓・テーブル 4人掛</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/diningtable2.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">食卓・テーブル 2人掛</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/lowtable.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ローテーブル</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/kotatsu.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">こたつ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/desk-d.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">机（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/desk-m.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">机（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/sofa3.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ソファー 3人掛</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/sofa2.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ソファー 2人掛</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/sofa1.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ソファー 1人掛</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/chair.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">椅子</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/massage.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">マッサージチェア</span>
              <span class="counter">
        ...
        <div class="form-row" style="grid-template-columns:1fr;">
          ...
          <div class="item-grid">
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/s-bed.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ベッド：シングル</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/d-bed.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ベッド：ダブル</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/q-bed.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ベッド：クイーン以上</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/h-bed.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ベッド：跳ね上げ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/c-bed.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ベッド：チェスト</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/loft-bed.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ベッド：ロフト</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/futon.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">布団</span>
              <span class="counter">
        ...
        <div class="form-row" style="grid-template-columns:1fr;">
          ...
          <div class="item-grid">
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/dressing-table.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">鏡台</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/sugata.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">姿見</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/metal-l.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">メタルラック（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/metal-s.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">メタルラック（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/butu1.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">仏壇（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/butu2.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">仏壇（小）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/carpet.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">カーペット</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/plant.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">観葉植物</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/storage-l.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">物置（大）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/storage-m.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">物置（小）</span>
              <span class="counter">
        ...
        <div class="form-row" style="grid-template-columns:1fr;">
          ...
          <div class="item-grid">
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/bicycle-l.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">自転車（大人）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/bicycle-m.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">自転車（子供）</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/golf.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ゴルフバッグ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/ski.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">スキー・スノーボード</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/electone.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">エレクトーン</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/d-piano.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">電子ピアノ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/clothesline-rack.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">物干し台</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/clothesline.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">物干し竿</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/hanger.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ハンガーパイプ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/water.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ウォーターサーバー</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/suit.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">スーツケース</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/sonotabox.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">その他ボックス</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/musical.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">楽器</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/cardboard.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">ダンボール</span>
              <span class="counter">
        ...
        <div class="form-row" style="grid-template-columns:1fr;">
          ...
          <div class="item-grid">
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/grand-p.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">グランドピアノ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/upright-piano.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">アップライトピアノ</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/car.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">乗用車</span>
              <span class="counter">
            ...
            <div class="item-row">
              <span class="thumb"><img src="<?php echo esc_url( get_theme_file_uri( '/assets/img/items/bike.webp' ) ); ?>" alt="" width="122" height="81" loading="lazy" decoding="async"></span><span class="name">バイク</span>
              <span class="counter">
