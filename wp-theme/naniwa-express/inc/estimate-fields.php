	...
	return array(
		...
		'estimate-step3' => array(
			...
			'fields' => array(
					...
					'from_bldg' => '建物名など',
					'from_zip2' => '郵便番号（2か所目）',
					'from_pref2' => '都道府県（2か所目）',
					'from_city2' => '市区町村（2か所目）',
					'from_street2' => '番地・号（2か所目）',
					'from_bldg2' => '建物名など（2か所目）',
					'from_type' => '建物の種類',
		...
		'estimate-step5' => array(
			...
			'fields' => array(
					...
					'from_distance' => '直前の道路から玄関までの距離（現在）',
					'to_distance' => '直前の道路から玄関までの距離（引越先）',
			),
		),
