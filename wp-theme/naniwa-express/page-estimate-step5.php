...
<div class="page-body">
  <div class="inner">
    ...
    <form class="form-card" action="<?php echo esc_url( home_url( '/estimate-step6-1/' ) ); ?>" method="post" novalidate>
      <h2>建物前の道路状況について</h2>
...
?>
      ...
      <button class="btn btn-back" type="submit" formaction="<?php echo esc_url( home_url( '/estimate-step4/' ) ); ?>" formnovalidate>←　戻る</button>
