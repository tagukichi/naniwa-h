  ...
  <div class="inner">
    ...
    <div class="block">
      ...
      <div class="notice-box">
        <p><strong>【確認待ち】</strong>回答本文は既存サイトの原稿を反映済みです（Sさん＝丁寧な文体、Nさん＝くだけた文体）。お二人の<strong>勤続年数・職種・お写真</strong>は仮のままですので、決まりましたらお知らせください。</p>
      </div>
      ...
      <div class="rc-people">
        <div class="rc-person">
          ...
          <div class="qa-list">
            <details class="faq-item" open>
              ...
              <div class="faq-answer"><p class="txt">体を動かす仕事が好きで、短期間でしっかり稼げるアルバイトを探していた時に、引越しの仕事に興味を持ち応募しました。未経験でも始めやすそうだったのも決め手でした。</p></div>
            </details>
            <details class="faq-item">
              <summary>やりがい</summary>
              <div class="faq-answer"><p class="txt">お客様の大切な荷物を丁寧に運び、無事に新しい生活のスタートをサポートできたときに大きな達成感があります。作業が終わったあとに「ありがとう」と直接感謝の言葉をいただけることも多く、それがやりがいにつながっています。また、体を動かす仕事なので、働きながら自然と体力がつくのも魅力です。</p></div>
            </details>
            <details class="faq-item">
              <summary>仕事を通じての思い出</summary>
              <div class="faq-answer"><p class="txt">最初は覚えることも多く不安でしたが、先輩が一つひとつ丁寧に教えてくれたおかげで、少しずつできることが増えていきました。チームで協力して一つの現場をやりきったときの達成感は今でも印象に残っています。忙しい現場でも声を掛け合いながら進めるので、自然と仲間との距離も縮まりました。</p></div>
            </details>
            <details class="faq-item">
              <summary>入社動機とこの会社に決めた理由</summary>
              <div class="faq-answer"><p class="txt">大手企業ではないからこそ、スタッフ同士の距離が近く、チーム一丸となって働ける環境に魅力を感じて入社を決めました。ベテランの方が多く在籍しており、現場でも常に周りを気にかけてくださる温かい職場だと感じています。未経験からスタートしたスタッフも多く、サポート体制が整っている点も安心できるポイントでした。</p></div>
            </details>
            <details class="faq-item">
              <summary>入社後の感想</summary>
              <div class="faq-answer"><p class="txt">実際に働いてみて感じたのは、「本当にみんなが優しい」ということです。引越し業界に対して、厳しい・体育会系といったイメージを持っていましたが、段ボールの持ち方から大型家電の運び方まで、一つひとつ丁寧に教えていただきました。未経験の方でも安心して働ける環境が整っていると感じています。</p></div>
            </details>
            <details class="faq-item">
              <summary>目標</summary>
              <div class="faq-answer"><p class="txt">先輩方のように、段取りよく作業を進めながら大型家電の搬入や複数の段ボールを効率よく運べるようになることが目標です。体力だけでなく技術も必要な仕事なので、先輩の動きを見て学び、分からないことは積極的に質問しながら日々努力しています。</p></div>
            </details>
            <details class="faq-item">
              <summary>入社を考えている方々にメッセージ</summary>
              <div class="faq-answer"><p class="txt">引越し業界というと「厳しそう」「怖そう」といったイメージを持っていましたが、実際に働いてみるとその印象はいい意味で大きく変わりました。スタッフはみんな優しく、未経験でもしっかりサポートしてもらえる環境です。体を動かすことが好きな方や、短期間でしっかり稼ぎたい方にはとてもおすすめの仕事です。安心してぜひ応募してみてください。</p></div>
            </details>
          </div>
        </div>
        ...
        <div class="rc-person">
          ...
          <div class="qa-list">
            <details class="faq-item" open>
              <summary>入社のきっかけ</summary>
              <div class="faq-answer"><p class="txt">体を動かすのが好きで、「短期でしっかり稼ぎたいな〜」と思っていたときに引越しのバイトを見つけて応募しました。未経験でもできそうだったのもポイントでした！</p></div>
            </details>
            <details class="faq-item">
              <summary>やりがい</summary>
              <div class="faq-answer"><p class="txt">最初は大変そうって思ってたんですが、終わったあとの達成感がめちゃくちゃ気持ちいいです！お客様から「ありがとう」って言ってもらえることも多くて、それが嬉しくてまた頑張ろうって思えます。体を動かすので、働きながらいい運動になるのも地味にありがたいです（笑）</p></div>
            </details>
            <details class="faq-item">
              <summary>仕事を通じての思い出</summary>
              <div class="faq-answer"><p class="txt">最初はわからないことだらけでしたが、先輩たちが優しく教えてくれてすぐに慣れました！チームで動く仕事なので、自然と仲良くなれるのもいいところです。忙しい現場をみんなで乗り切ったときは、ちょっとした一体感があって楽しいですよ。</p></div>
            </details>
            <details class="faq-item">
              <summary>入社動機とこの会社に決めた理由</summary>
              <div class="faq-answer"><p class="txt">大きい会社じゃない分、みんなで協力して働いてる感じがいいなと思って決めました！ベテランの先輩も多くて、ちゃんと気にかけてくれるので、すごくあったかい職場だなって思ってます。未経験スタートの人も多いので、初めてでも全然大丈夫です！</p></div>
            </details>
            <details class="faq-item">
              <summary>入社後の感想</summary>
              <div class="faq-answer"><p class="txt">実際に働いてみて思ったのは、とにかくみんな優しいってことです！正直、引越し屋さんって怖そうなイメージがあったんですが、ダンボールの持ち方から家電の運び方まで全部ちゃんと教えてくれて、「こんな優しい引越し屋さんあるんだ！」ってびっくりしました（笑）未経験でもちゃんと教えてもらえるので安心です！</p></div>
            </details>
            <details class="faq-item">
              <summary>目標</summary>
              <div class="faq-answer"><p class="txt">先輩みたいにテキパキ動いて、大きい家電とかもサクッと運べるようになるのが目標です！体力だけじゃなくてコツとかテクニックも大事なので、見て覚えて聞いて覚えてって感じで頑張ってます！</p></div>
            </details>
            <details class="faq-item">
              <summary>入社を考えている方々にメッセージ</summary>
              <div class="faq-answer"><p class="txt">最初は「2〜3回やって辞めようかな」くらいの気持ちだったんですが、働いてみたら環境が良くてそのまま続けてます（笑）自分も引越し屋さん＝怖い・体育会系って思ってたんですが、ここではそのイメージがいい意味で180度変わりました！未経験でもちゃんとサポートしてもらえるので安心ですし、気づいたら長く続けたくなるくらい働きやすい職場です！</p></div>
            </details>
          </div>
        </div>
      </div>
            ...
            <tr>
              ...
              <td>
                <ul class="rc-benefits">
                  ...
                  <li>直行・直帰OK！</li>
                  <li>制服貸与</li>
                  <li>髪型・髪色・ネイル・ピアス自由♪</li>
                </ul>
                <p class="note">★弊社では独自で項目を作成し、達成する事で給与が上がるシステムを導入しております。</p>
              </td>
            </tr>
            <tr>
              <th>応募条件</th>
