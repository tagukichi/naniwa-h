...
?>
      ...
      <button class="btn btn-back" type="submit" name="naniwa_next" value="estimate-items" formnovalidate>←　戻る</button>
      <button class="btn btn-primary" type="submit" name="naniwa_next" value="estimate-confirm">入力内容を確認する　→</button>
      </div>
    </form>
